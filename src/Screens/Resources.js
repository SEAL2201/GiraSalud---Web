      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {resources.map((resource, index) => (
            <div key={resource.id} style={{ backgroundColor: colors[index % colors.length] }} className= {`${styles.btnGradient} shadow-md rounded-lg p-6 flex flex-col items-center text-center`}>
        ...
        {selectedResource && (
          <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-8 rounded-lg max-w-md">
              ...
              <div className="text-2xl text-[#565B80] mb-4">
